...
import com.example.a66.data.model.RemoteNobelResponseRetrofit
import com.example.a66.data.model.toDomain
import com.example.a66.data.remote.RetrofitClient
...
class RetrofitNobelPrizeRepositoryImpl : NobelPrizeRepository {
    override suspend fun filterNobelPrize(nobelPrizeYear: Int?, nobelPrizeCategory: String?): List<NobelPrize> {
        return try {
            ...
            val all = body.nobelPrizes.map { it.toDomain() }
            all.filter { p ->
